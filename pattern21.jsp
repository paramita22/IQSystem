...
<title>pattern21 # IQSystem</title>
<style>
.container-fluid{
min-height:520px;
min-width:1000px;
...
<br/><br/><br/><br/>Q. 4. <img src="images/pattern4.jpg"/></div><div class="col-xs-4">
<div class="panel panel-primary"><div class="panel-heading"><h6>Find the One that comes next:</h6></div>
<div class="panel-body"><img src="images/pattern4a.jpg"><input type="checkbox" id="check1"/>A.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src="images/pattern4b.jpg"/>
<input type="checkbox" id="check1"/>B.<br/><br/>
<img src="images/pattern4c.jpg"/><input type="checkbox" id="check1"/>C.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src="images/pattern4d.jpg"/><input type="checkbox" id="check1"/>D.</div>
<div class="panel-footer"><a href="pattern13.jsp"><input type="button" value="Previous" class="btn btn-danger"/></a><a href="pattern22.jsp"><input type="button" class="btn btn-primary" value="Save and Next" style="float:right;"/></a></div></div></div></div>
</form></div>
