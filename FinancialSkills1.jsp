...
<title>FinancialSkillTest=>Page1 # IQSystem</title>
<style>
.container-fluid{
height:660px;
width:900px;
...
<h4>Exam Name:<br/>CUSTOMISED TEST ON FINANCIAL SKILL</h4>
...
<li class="navbar-item"><a class="nav-link" href="UserLogout.jsp"><i class="fa fa-plane"></i>UserLogout</a></li></ul>
            ...
            <div class="panel-heading" style="height:150px;background-color:blue;color:#ffffff;"><img src="images/AI11.png"/><br/>
                ...
                <% 
                ResultSet rs1=st.executeQuery("select financial_ques from financial_skill where financial_quesid=411");
                %>
                <%
                while(rs1.next()){
               ...
               <br/>
                  ...
                  <%  ResultSet rs2=st.executeQuery("select financial_ansid,financial_ans from financial_skill_ans where financial_quesid=411");
                 while(rs2.next()){
                 %>
                 <input type="checkbox" class="cgroup" name="financial_ansid" id="fans1" onclick="message();">
                 <%
                ...
                <%}
                 ResultSet rs211=st.executeQuery("select financial_ansid from financial_skill_ans where financial_quesid=411");
                 while(rs211.next()){
                 if(Boolean.parseBoolean(request.getParameter("managementr_ansid"))==true){
                	 ans1=rs211.getInt(1);
                	 count++;
                	 if(count>1){
                		 ans1=0;
                     ...
                     %>
                  <br/>
              <%  ResultSet rs3=st.executeQuery("select financial_ques from financial_skill where financial_quesid=412");
                %><br/><br/>
                ...
                <br/><br/>
                  ...
                  <%   ResultSet rs4=st.executeQuery("select financial_ans from financial_skill_ans where financial_quesid=412");
                while(rs4.next()){%>
                <input type="checkbox" class="cgroup" name="financial_ansid" id="fans2" onclick="message();">
 ...
 <br/>
                    ...
                    <div class="panel-footer"><a href="FinancialSkills2.jsp"><input type="button" value="Save and Next" class="btn btn-danger"/></a></div>
